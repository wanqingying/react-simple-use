(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactSimpleUse = {}));
	...
	*/
	...
	class EventEmitter {
	    constructor() {
	        ...
	        this.useSubscription = (event, cb) => {
	            let subs = this.subs.get(event);
	            if (!subs) {
	                subs = new Set();
	...
	function getSimpleContext(iniState) {
	    const Context = react.createContext({});
	    const Provider = function (props) {
	        const state = react.useRef(new SimpleState(Object.assign(Object.assign({}, (props.iniState || {})), (iniState || {}))));
	        return (react.createElement(Context.Provider, { value: state.current }, props.children));
	    };
	    const useSimpleContext = (subKeys) => {
	        const ctx = react.useContext(Context);
	        const [state, setState] = react.useState(ctx.getState());
